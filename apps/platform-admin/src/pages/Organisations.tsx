...
export default function Organisations() {
  ...
  return <div className="admin-page organisations-page">
    ...
    <div className="restaurant-workspace">
      ...
      <section className="restaurant-detail">{!selected ? <div className="panel-empty"><strong>{loading ? 'Loading organisations…' : groups.length ? 'Select an organisation' : 'No organisations yet'}</strong>{!loading && groups.length === 0 && <span>Create your first enterprise organisation below.</span>}</div> : <>
