  ...
  return (
    <main className="customer-home-page">
      ...
      <section className="customer-home-grid" aria-label="Account sections">
        ...
        <Link to="/account/challenges"><span className="customer-home-icon">◆</span><div><strong>Challenges</strong><small>Missions, achievements and leaderboards</small></div><span>›</span></Link>
