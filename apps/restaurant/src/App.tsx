...
export default function App() {
  return <PlatformConfigurationProvider><PlatformStatusBoundary><SubscriptionAccessProvider><ApplicationRoutes /></SubscriptionAccessProvider></PlatformStatusBoundary></PlatformConfigurationProvider>
}
...
function ApplicationRoutes() {
  ...
  return <Routes>
    ...
    <Route path="/r/:slug" element={<><Storefront /><StorefrontGiftCardButton /></>} />
