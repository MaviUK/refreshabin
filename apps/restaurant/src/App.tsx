...
<Route path="/dashboard" element={<ProtectedRoute><Dashboard/></ProtectedRoute>}/><Route path="/orders" element={<ProtectedRoute><Orders/></ProtectedRoute>}/><Route path="/kds" element={<ProtectedRoute><KitchenDisplay/></ProtectedRoute>}/><Route path="/printers" element={<ProtectedRoute><PrinterManagement/></ProtectedRoute>}/><Route path="/print-history" element={<ProtectedRoute><PrintHistory/></ProtectedRoute>}/><Route path="/onboarding" element={<ProtectedRoute allowApplication><Onboarding/></ProtectedRoute>}/><Route path="/menu" element={<ProtectedRoute><MenuBuilder/></ProtectedRoute>}/><Route path="/menu/modifiers" element={<ProtectedRoute><ModifierGroups/></ProtectedRoute>}/><Route path="/opening-hours" element={<ProtectedRoute><OpeningHours/></ProtectedRoute>}/><Route path="/branding" element={<ProtectedRoute><Branding/></ProtectedRoute>}/><Route path="/settings" element={<ProtectedRoute><RestaurantSettings/></ProtectedRoute>}/><Route path="/restaurant-details" element={<ProtectedRoute><RestaurantDetails/></ProtectedRoute>}/><Route path="/delivery-areas" element={<ProtectedRoute><DeliveryAreas/></ProtectedRoute>}/><Route path="/delivery-map" element={<ProtectedRoute><DeliveryMap/></ProtectedRoute>}/><Route path="/payments" element={<ProtectedRoute allowPaymentSetup><Payments/></ProtectedRoute>}/><Route path="/finance" element={<ProtectedRoute><Finance/></ProtectedRoute>}/><Route path="/subscription" element={<ProtectedRoute allowPaymentSetup><Subscription/></ProtectedRoute>}/><Route path="/insights/*" element={<ProtectedRoute><AIInsights/></ProtectedRoute>}/><Route path="/marketing" element={<ProtectedRoute><MarketingOverview/></ProtectedRoute>}/><Route path="/marketing/crm" element={<ProtectedRoute><MarketingCRM/></ProtectedRoute>}/><Route path="/marketing/customers" element={<ProtectedRoute><MarketingCRM/></ProtectedRoute>}/><Route path="/marketing/crm/:customerId" element={<ProtectedRoute><MarketingCustomer/></ProtectedRoute>}/><Route path="/marketing/segments" element={<ProtectedRoute><Segments/></ProtectedRoute>}/><Route path="/marketing/campaigns" element={<ProtectedRoute><Campaigns/></ProtectedRoute>}/><Route path="/marketing/templates" element={<ProtectedRoute><MarketingTemplates/></ProtectedRoute>}/><Route path="/marketing/automations" element={<ProtectedRoute><Automations/></ProtectedRoute>}/><Route path="/marketing/reports" element={<ProtectedRoute><MarketingReports/></ProtectedRoute>}/><Route path="/marketing/analytics" element={<ProtectedRoute><MarketingReports/></ProtectedRoute>}/><Route path="/marketing/settings" element={<ProtectedRoute><MarketingSettings/></ProtectedRoute>}/><Route path="/marketing/milestones" element={<ProtectedRoute><Milestones/></ProtectedRoute>}/><Route path="/marketing/vip" element={<ProtectedRoute><VipProgramme/></ProtectedRoute>}/><Route path="/marketing/challenges" element={<ProtectedRoute><Challenges/></ProtectedRoute>}/><Route path="/gift-cards" element={<ProtectedRoute><GiftCards/></ProtectedRoute>}/><Route path="/loyalty" element={<ProtectedRoute><LoyaltySettings/></ProtectedRoute>}/><Route path="/loyalty/rewards" element={<ProtectedRoute><RewardsManagement/></ProtectedRoute>}/><Route path="/loyalty/referrals" element={<ProtectedRoute><ReferralProgram/></ProtectedRoute>}/><Route path="/loyalty/stamps" element={<ProtectedRoute><StampPrograms/></ProtectedRoute>}/><Route path="/loyalty/stamps/operations" element={<ProtectedRoute><StampOperations/></ProtectedRoute>}/><Route path="/loyalty/stamps/analytics" element={<ProtectedRoute><StampAnalytics/></ProtectedRoute>}/><Route path="*" element={<Navigate to="/" replace/>}/>
</Routes>}
