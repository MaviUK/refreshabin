...
<Route path="/account/login" element={<CustomerLogin/>}/><Route path="/account/register" element={<CustomerRegister/>}/><Route path="/account/forgot-password" element={<CustomerForgotPassword/>}/><Route path="/account/reset-password" element={<CustomerResetPassword/>}/><Route path="/account" element={<CustomerAccountHome/>}/><Route path="/account/profile" element={<CustomerProfile/>}/><Route path="/account/orders" element={<CustomerOrders/>}/><Route path="/account/addresses" element={<CustomerAddresses/>}/><Route path="/account/wallet" element={<CustomerWallet/>}/><Route path="/account/loyalty" element={<CustomerLoyalty/>}/><Route path="/account/favourites" element={configuration.feature_flags.customer_favourites?<CustomerFavourites/>:<Navigate to="/account" replace/>}/>
