  ...
  return (
    <main className="marketing-shell">
      <header className="marketing-header">
        ...
        <div className="marketing-header-actions"><Link className="secondary-button button-link" to="/marketing/vip">VIP Programme</Link><Link className="secondary-button button-link" to="/marketing/milestones">Birthdays & milestones</Link><Link className="secondary-button button-link" to="/dashboard">Dashboard</Link><button className="primary-button" type="button" onClick={() => setShowForm((value) => !value)}>{showForm ? 'Close builder' : 'New promotion'}</button></div>
      </header>
      ...
      <section className="marketing-tools-grid">
        ...
        <Link className="marketing-tool-card marketing-tool-card--active" to="/marketing/vip"><span>VIP</span><strong>Tiers, benefits & membership</strong><small>Live now</small></Link>
