export default function App() { const services = [ { title: "Domestic Bin Cleaning", text: "Keep household bins clean, hygienic, and odour-free with regular scheduled washing.", }, { title: "Commercial Bin Cleaning", text: "Reliable cleaning for larger bins, shared waste areas, apartment blocks, and business premises.", }, { title: "One-Off & Regular Plans", text: "Book a single clean or choose a repeat service to keep bins fresh all year round.", }, ];

const highlights = [ "Commercial & Residential", "Co. Down coverage", "Fresh, hygienic bins", "Simple online booking", ];

const pricing = [ { title: "One-Off Clean", price: "£6", note: "Ideal for a one-time freshen up" }, { title: "4 Weekly Plan", price: "£5", note: "Best value recurring clean" }, { title: "Commercial Quote", price: "Custom", note: "Tailored for larger sites" }, ];

return ( <div className="min-h-screen bg-[#eef7ff] text-slate-900"> <header className="sticky top-0 z-20 border-b border-[#cfe7ff] bg-white/90 backdrop-blur"> <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4"> <div className="flex items-center gap-4"> <img src="/logo.jpeg" alt="RefreshaBin logo" className="h-14 w-auto sm:h-16" /> </div>
  ...
  <section className="mx-auto max-w-7xl px-6 py-16">
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <div id="areas" className="rounded-[2rem] border border-[#d9efdc] bg-gradient-to-br from-[#ffffff] to-[#f3fff6] p-8 shadow-sm">
        ...
        <h2 className="mt-3 text-4xl font-black text-[#0c2340]">Serving Co. Down</h2>
        <p className="mt-5 leading-7 text-slate-600">
          Add your exact towns or service areas here so customers instantly know whether they can book. This section can list Bangor, Newtownards, Holywood, Comber, Dundonald, or wherever you cover.
        </p>
        <div className="mt-6 flex flex-wrap gap-3">
          {["Bangor", "Newtownards", "Holywood", "Comber", "Dundonald", "Commercial Sites"].map((area) => (
