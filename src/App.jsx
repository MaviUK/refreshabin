  ...
  const pricing = [
    {
      title: "One-Off Clean",
      price: "£15",
      note: "A convenient single clean for bins that need freshened up",
    },
    {
      title: "4 Weekly Service",
      price: "£5",
      note: "Our most popular regular cleaning option",
    },
    {
      title: "Commercial Quote",
      price: "Custom",
      note: "Tailored pricing for larger sites and business needs",
    },
  ];
      ...
      <header className="sticky top-0 z-20 hidden border-b border-[#cfe7ff] bg-white/90 backdrop-blur md:block">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-8 text-sm font-semibold text-slate-700 md:flex">
            <a href="#services" className="transition hover:text-[#0b67c2]">
              Services
            </a>
            <a href="#pricing" className="transition hover:text-[#0b67c2]">
              Pricing
            </a>
            <a href="#areas" className="transition hover:text-[#0b67c2]">
              Areas We Cover
            </a>
            <a href="#book" className="transition hover:text-[#0b67c2]">
              Book Now
            </a>
          </nav>
...
/>
  ...
  >
    Prices
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              <div className="rounded-[1.75rem] border border-[#cce8ff] bg-white p-5 shadow-sm">
                ...
                <div className="mt-1 text-sm text-slate-600">
                  Helping reduce odours, bacteria, and bin build-up
                </div>
              </div>
              <div className="rounded-[1.75rem] border border-[#d9efdc] bg-white p-5 shadow-sm">
                <div className="text-2xl font-black text-[#22a94f]">
                  Reliable
                </div>
                <div className="mt-1 text-sm text-slate-600">
                  Dependable one-off and scheduled cleaning services
                </div>
              </div>
              <div className="rounded-[1.75rem] border border-[#cce8ff] bg-white p-5 shadow-sm">
                <div className="text-2xl font-black text-[#0d67c2]">
                ...
                <div className="mt-1 text-sm text-slate-600">
                  A trusted service for homes, businesses, and shared areas
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="mb-6">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#18a7f5]">
                Quick Booking
              </p>
              <h2 className="mt-2 text-3xl font-black text-[#0c2340]">
                Book your bin clean
              </h2>
              <p className="mt-2 text-sm text-slate-500">
                Arrange a domestic or commercial clean in just a few steps.
              </p>
            </div>
            ...
            <div className="mt-5 rounded-2xl bg-[#eff8ff] p-4 text-sm text-slate-600">
              Professional bin cleaning for homes, businesses, apartment
              blocks, and shared waste areas across County Down.
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 py-8">
        <div className="mb-8 text-center">
          ...
          <h2 className="mt-3 text-4xl font-black text-[#0c2340]">
            Domestic and commercial bin cleaning
          </h2>
          <p className="mx-auto mt-4 max-w-3xl text-slate-600">
            We provide professional bin cleaning services for households,
            commercial sites, shared bin stores, and residential developments.
          </p>
        </div>
            ...
            >
              <div
                className={`inline-flex rounded-full px-3 py-1 text-xs font-bold uppercase tracking-[0.2em] ${
                  index === 1
                    ? "bg-[#ecfaef] text-[#22964a]"
                    : "bg-[#eef8ff] text-[#0d67c2]"
                }`}
              >
                {index === 1 ? "Commercial" : "Service"}
              </div>
              <h3 className="mt-5 text-2xl font-bold text-[#0c2340]">
                {item.title}
              </h3>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-[2rem] border border-[#cce8ff] bg-white p-8 shadow-sm">
            ...
            <ul className="mt-6 space-y-4 text-slate-600">
              ...
              <li>
                • Suitable for homes, businesses, apartment blocks, and shared
                bin areas
              </li>
          ...
          >
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#22a94f]">
              Areas We Cover
            </p>
            <h2 className="mt-3 text-4xl font-black text-[#0c2340]">
              Bin cleaning across local towns and surrounding areas
            </h2>
            <p className="mt-5 leading-7 text-slate-600">
              We proudly provide professional bin cleaning services across the
              following areas:
            </p>
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-6 py-4 pb-16">
        <div className="text-center">
          ...
          <h2 className="mt-3 text-4xl font-black text-[#0c2340]">
            Straightforward pricing for homes and businesses
          </h2>
        </div>
          ...
          {pricing.map((item, index) => (
            <div
              ...
              className={`rounded-[2rem] border bg-white p-8 text-center shadow-sm ${
                index === 1
                  ? "border-[#22c55e] ring-2 ring-[#dff6e8]"
                  : "border-[#cce8ff]"
              }`}
            >
              ...
              <div
                className={`mt-5 text-5xl font-black ${
                  index === 1 ? "text-[#22a94f]" : "text-[#0d67c2]"
                }`}
              >
                {item.price}
              </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <h2 className="text-4xl font-black">
                Ready to book your bin clean?
              </h2>
              <p className="mt-4 max-w-2xl text-white/90">
                Choose a one-off clean or set up a regular service to keep your
                bins looking cleaner, smelling fresher, and maintained all year
                round.
              </p>
            </div>
            <a
...
function BookingModal({ draft, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!allBinsValid) {
      alert(
        "Please complete all bin details, including type, quantity, clean type, and date."
      );
      return;
    }
              ...
              >
                <div className="grid grid-cols-[1fr_90px] gap-3">
                  <select
                    value={bin.binType}
                    onChange={(e) =>
                      updateBin(index, "binType", e.target.value)
                    }
                  ...
                  <input
                    ...
                    value={bin.quantity}
                    onChange={(e) =>
                      updateBin(index, "quantity", Number(e.target.value))
                    }
                    className="rounded-2xl border border-slate-300 px-4 py-3"
                  />
                </div>
                ...
                <select
                  value={bin.cleanType}
                  onChange={(e) =>
                    updateBin(index, "cleanType", e.target.value)
                  }
                  className="w-full rounded-2xl border border-slate-300 px-4 py-3"
                >
                  <option>One-Off Clean</option>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              {termsOpened && (
                <div className="mt-4 max-h-48 overflow-y-auto rounded-xl border border-slate-200 bg-white p-3 text-sm text-slate-600">
                  ...
                  <p>
                    Customers must ensure bins are accessible on the agreed
                    date.
                  </p>
                  <p>Missed appointments may require rebooking.</p>
                  <p>
                    Service pricing may vary if the selected booking details are
                    changed.
                  </p>
                  <p>
                    By booking, you agree to the service terms and contact
